...
exports.default = {
    ...
    async beforeUpdate(event) {
        ...
        if (!article.publishedAt) {
            ...
            const origin = await strapi.entityService.findOne('api::magazine.magazine', isNotUpdatingExistingOrigin ? article.origin.id : (_k = data.origin) === null || _k === void 0 ? void 0 : _k.connect[0].id);
