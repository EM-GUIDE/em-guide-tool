...
export interface ApiTranslationRequestTranslationRequest
  ...
  attributes: {
    ...
    language: Attribute.Relation<
      ...
      'api::language.language'
    >;
    original_language: Attribute.Relation<
      'api::translation-request.translation-request',
      'oneToOne',
      'api::language.language'
    >;
...
export interface PluginAdminCommentsComment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    entitySlug: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'plugin::admin-comments.comment',
      'oneToOne',
...
export interface PluginPaperTrailTrail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    recordId: Attribute.BigInteger & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'plugin::paper-trail.trail',
      'oneToOne',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::admin-comments.comment': PluginAdminCommentsComment;
